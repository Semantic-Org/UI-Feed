...
This repository contains pre-compiled feed files using the default themes. This is intended for use in projects that do not need all the bells and whistles of Semantic UI, and want to keep file size to a minimum.

For the latest changes please see the [Release Notes](https://github.com/Semantic-Org/UI-Feed/blob/master/RELEASE-NOTES.md)
...
```
bower install semantic-ui-feed
```

#### To install with NPM
```
npm install semantic-ui-feed
```

#### To install with Meteor
```
meteor add semantic:ui-feed
```
